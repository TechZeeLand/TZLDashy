...
<div class="page-wrap" style="max-width:960px">
  ...
  <div class="info-grid">
    ...
    <div class="info-card">
      <div class="info-icon">📦</div>
      <h3>Open Source</h3>
      <p>TZLDashy is fully open source. Contributions, issues, and stars are welcome on GitHub.</p>
    </div>
    <div class="info-card">
      <div class="info-icon">🐳</div>
      <h3>Docker Ready</h3>
      <p>Deploy in seconds with a single <code>docker-compose up</code>. MariaDB + phpMyAdmin included.</p>
    </div>
    <div class="info-card">
      <div class="info-icon">🔒</div>
      <h3>Secure by Default</h3>
      <p>Multi-user login with admin roles, TOTP authenticator app 2FA, and email OTP support.</p>
    </div>
    <div class="info-card">
      <div class="info-icon">📊</div>
      <h3>Live Stats</h3>
  ...
  <div class="settings-card" style="margin-top:0">
    <div class="settings-card-title">📋 Technical Details</div>
    <table class="data-table">
      <tbody>
        ...
        <tr><td style="color:var(--muted)">Stack</td><td>PHP 8.2, Nginx, MariaDB 10.11, phpMyAdmin</td></tr>
        <tr><td style="color:var(--muted)">Port</td><td>1011</td></tr>
        ...
        <tr><td style="color:var(--muted)">License</td><td>MIT License</td></tr>
